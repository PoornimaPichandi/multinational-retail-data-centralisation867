...
def main():    
    ...
    #user_df.to_csv (r'C:/Users/poorn/Documents/Python Scripts/git_repo/multinational-retail-data-centralisation867/export_user_dataframe.csv', index = None, header=True) 
    print("First few rows of the user DataFrame:\n", user_df.head())

    # Extract orders data
    orders_df = data_extractor.read_rds_table(rds_engine, 'orders_table')
    #orders_df.to_csv (r'C:/Users/poorn/Documents/Python Scripts/git_repo/multinational-retail-data-centralisation867/export_orders_dataframe.csv', index = None, header=True) 
    print("First few rows of the orders DataFrame:\n", orders_df.head())

    # Clean user data
    cleaned_user_df = data_cleaning.clean_user_data(user_df)
    cleaned_user_df.to_csv (r'C:/Users/poorn/Documents/Python Scripts/git_repo/multinational-retail-data-centralisation867/dim_users.csv', index = None, header=True) 

    # Cleaned orders data
    cleaned_orders_df = data_cleaning.clean_orders_data(orders_df)
    cleaned_orders_df.to_csv (r'C:/Users/poorn/Documents/Python Scripts/git_repo/multinational-retail-data-centralisation867/orders_table.csv', index = None, header=True) 
    ...
    #pdf_data_df.to_csv (r'C:/Users/poorn/Documents/Python Scripts/git_repo/multinational-retail-data-centralisation867/pdf_data_df.csv', index = None, header=True) 
    print("First few rows of the PDF DataFrame:\n", pdf_data_df.head())

    #cleaned card data 
    clean_card_data = data_cleaning.clean_card_data(pdf_data_df)
    clean_card_data.to_csv (r'C:/Users/poorn/Documents/Python Scripts/git_repo/multinational-retail-data-centralisation867/dim_card_details.csv', index = None, header=True) 
    ...
    #stores_df.to_csv (r'C:/Users/poorn/Documents/Python Scripts/git_repo/multinational-retail-data-centralisation867/stores_df.csv', index = None, header=True) 
    print("First few rows of cleaned:\n",stores_df.head())

    #clean store data
    clean_store_data = data_cleaning.clean_store_data(stores_df)
    clean_store_data.to_csv (r'C:/Users/poorn/Documents/Python Scripts/git_repo/multinational-retail-data-centralisation867/dim_store_details.csv', index = None, header=True) 
    ...
    #products_df.to_csv (r'C:/Users/poorn/Documents/Python Scripts/git_repo/multinational-retail-data-centralisation867/products_df.csv', index = None, header=True) 
    ...
    #converted_products_df.to_csv (r'C:/Users/poorn/Documents/Python Scripts/git_repo/multinational-retail-data-centralisation867/converted_products_df.csv', index = None, header=True) 
    ...
    clean_products_data.to_csv (r'C:/Users/poorn/Documents/Python Scripts/git_repo/multinational-retail-data-centralisation867/dim_products.csv', index = None, header=True) 
    ...
    #date_details_df.to_csv (r'C:/Users/poorn/Documents/Python Scripts/git_repo/multinational-retail-data-centralisation867/date_details_df.csv', index = None, header=True) 
    ...
    cleaned_date_details_df.to_csv (r'C:/Users/poorn/Documents/Python Scripts/git_repo/multinational-retail-data-centralisation867/dim_date_times.csv', index = None, header=True) 
